...
const DEFAULT_EMPIRE_CONFIG = {
  ...
  agents: {
    ...
    "empire-grand-secretary-a": { model: "cockpit/gpt-5.5", permission: { edit: "deny", bash: "ask", task: "deny" } },
    "empire-grand-secretary-b": { model: "cockpit/gpt-5.4", permission: { edit: "deny", bash: "ask", task: "deny" } },
    "empire-grand-secretary-c": { model: "opencode-go/deepseek-v4-flash", permission: { edit: "deny", bash: "ask", task: "deny" } },
    "empire-ministry-personnel": { model: "cockpit/gpt-5.4", permission: { edit: "deny", bash: "ask", task: "deny" } },
    "empire-ministry-revenue": { model: "opencode-go/deepseek-v4-flash", permission: { edit: "deny", bash: "ask", task: "deny" } },
    "empire-ministry-rites": { model: "cockpit/gpt-5.4", permission: { edit: "deny", bash: "ask", task: "deny" } },
    "empire-ministry-war": { model: "cockpit/gpt-5.4", permission: { edit: "deny", bash: "ask", task: "deny" } },
    "empire-ministry-justice": { model: "cockpit/gpt-5.5", permission: { edit: "deny", bash: "ask", task: "deny" } },
    "empire-ministry-works": { model: "cockpit/gpt-5.5", permission: { edit: "ask", task: "deny" } },
  },
  disabledRoles: [],
};
