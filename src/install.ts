...
const DEFAULT_EMPIRE_CONFIG = {
  ...
  agents: {
    "empire-cabinet": { model: "cockpit/gpt-5.4", options: { reasoningEffort: "medium" } },
    "empire-eunuch": { model: "cockpit/gpt-5.4", options: { reasoningEffort: "medium" } },
    "empire-grand-secretary-a": { model: "cockpit/gpt-5.5", options: { reasoningEffort: "high" } },
    "empire-grand-secretary-b": { model: "cockpit/gpt-5.4", options: { reasoningEffort: "medium" } },
    "empire-grand-secretary-c": { model: "opencode-go/deepseek-v4-flash", options: { reasoningEffort: "low" } },
    "empire-ministry-personnel": { model: "cockpit/gpt-5.4", options: { reasoningEffort: "medium" } },
    "empire-ministry-revenue": { model: "opencode-go/deepseek-v4-flash", options: { reasoningEffort: "low" } },
    "empire-ministry-rites": { model: "cockpit/gpt-5.4", options: { reasoningEffort: "medium" } },
    "empire-ministry-war": { model: "cockpit/gpt-5.4", options: { reasoningEffort: "medium" } },
    "empire-ministry-justice": { model: "cockpit/gpt-5.5", options: { reasoningEffort: "high" } },
    "empire-ministry-works": { model: "cockpit/gpt-5.5", options: { reasoningEffort: "high" } },
  },
  disabledRoles: [],
};
