...
export const EMPIRE_ROLES: EmpireRole[] = [
  ...
  { id: "empire-ministry-rites", title: "礼部", office: "礼部", description: "可见 subagent。负责规格审查、方案审核、交互文案、角色口吻和文档表达。审查不通过时应封驳。", mode: "subagent", hidden: false, canEdit: false, defaultModel: DEFAULT_MODELS.standard },
  ...
  { id: "empire-ministry-justice", title: "刑部", office: "刑部", description: "可见 subagent。负责代码审查、测试把关、权限和风险审查。审查不通过时应封驳。", mode: "subagent", hidden: false, canEdit: false, defaultModel: DEFAULT_MODELS.strong },
